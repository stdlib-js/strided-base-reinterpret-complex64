...
```javascript
import reinterpret from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-reinterpret-complex64@v0.1.0-deno/mod.js';
```
...
[@stdlib/array/float32]: https://github.com/stdlib-js/stdlib/tree/deno
